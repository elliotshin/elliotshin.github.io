...
Wow! Looks complex doesn't it? It is actually a really simple line of code if you know your data types and functions
 ...
 Essentially, since each penguin is recorded as ___ penguin. We are just interested in gaining the ___ . This code extracts the first word of each value in the Species column by turning the whole entry into a list and just getting the first element of that list. 
